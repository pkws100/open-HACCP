...
namespace {
const char PortalHtml[] PROGMEM = R"HTML(<!doctype html>
...
{
    const uint32_t mac = ESP.getChipId();
    char suffix[7];
...
void ProvisioningPortal::handleRoot()
{
    ...
    server_.send_P(200, PSTR("text/html; charset=utf-8"), PortalHtml);
}
