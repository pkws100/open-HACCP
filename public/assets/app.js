import { api, setCsrfToken } from './api.js?v=20260809-2';
import { overviewView } from './views/overview.js?v=20260809-2';
import { analysisView } from './views/analysis.js?v=20260809-2';
import { eventsView } from './views/events.js?v=20260809-2';
import { exportsView } from './views/exports.js?v=20260809-2';
import { usersView } from './views/users.js?v=20260809-2';
import { establishmentView } from './views/establishment.js?v=20260809-2';
...
document.querySelector('#logout').addEventListener('click', async () => { try { await api('/api/v1/auth/logout', { method: 'POST' }); } finally { window.location.replace('/login'); } });
await route();
