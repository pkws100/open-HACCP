...
import { alarmLabel, escapeHtml, formatDate, formatNumber, metric, powerLabel, signalIcon, statusPill } from '../format.js?v=20260923-1';
...
function settingsDialog() {
  ...
  const batteryFields = state.data.selected_device.battery.power_source === 'mains'
