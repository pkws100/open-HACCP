...
Der Betreiber hat beim zweiten Gerät inzwischen nur den DHT22 in der Tiefkühltruhe platziert; ESP32 und eine nach seiner Angabe geregelte USB-Powerbank stehen außerhalb. Nach dem Umstecken zeigte das Backend zunächst weiterhin die letzte vor dem Einbau angenommene Messung von **23,5 °C / 46,6 % rF um 23:57 Uhr**. Die Firmware bewahrt ihren letzten erfolgreichen Upload-Zeitpunkt bei einem Stromwechsel auf und sendet bei 6 Stunden Vorgabe nicht automatisch sofort nach dem Einschalten. Unter erreichbarem WLAN und ohne Fehlersituation ist der nächste reguläre Kontakt etwa **05:57 Uhr** zu erwarten, eventuell früher wegen Pufferdruck. Ein neuer Kälte-Messwert, DHT-Signalqualität an der verlängerten Leitung und ein ACK an der Powerbank wurden noch nicht geprüft. Der noch offene Raumtemperatur-Alarm darf nicht als bestätigte Kühlschranktemperatur interpretiert werden.
